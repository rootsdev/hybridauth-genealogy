        ...
        <table width="100%">
          <tr>
            <td width="150" valign="top" align="center">
				...
				?>
					<a href="<?php echo $user_data->profileURL; ?>"><img src="<?php echo $user_data->photoURL; ?>" title="<?php echo $user_data->displayName; ?>" border="0" style="height: 120px;"></a>
				<?php
					}
					else{
				?> 
            ...
            <td align="left"><table width="100%" cellspacing="0" cellpadding="3" border="0">
                <tbody>
                  ...
                  <tr>
                    <td>profileURL</td>
                    <td>&nbsp; <a href="<?=$user_data->profileURL?>"><?php echo $user_data->profileURL; ?></a></td>
                  </tr>
                  <? endif; ?>
                  <? if (!empty($user_data->photoURL)) : ?>                  
                  <tr>
                    <td>photoURL</td>
                    <td>&nbsp; <a href="<?=$user_data->photoURL?>"><?php echo $user_data->photoURL; ?></a></td>
                  </tr>
                  <? endif; ?>
                  ...
                  <tr>
                    <td>email</td>
                    <td>&nbsp; <a href="mailto:<?=$user_data->email?>"><?php echo $user_data->email; ?></a></td>
                  </tr>
                  <? endif; ?>
